...
public class PanelProductsAdmin extends Pnl {
    ...
    private void initComponents() {
        ...
        ((PlainDocument) txf_cost.getDocument()).setDocumentFilter(new MyDoubleFilter());

        lbl_cost.setText("Costo : ");

        lbl_descProduct.setText("Descripcion :");

        ((PlainDocument) txf_descProduct.getDocument()).setDocumentFilter(new MyAlphaNumericFilter());
        ...
        ((PlainDocument) txf_codeProduct.getDocument()).setDocumentFilter(new MyAlphaNumericFilter());
        ...
        pnl_codesProductLayout.setVerticalGroup(
            ...
            .addGroup(pnl_codesProductLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(lbl_idProduct, javax.swing.GroupLayout.PREFERRED_SIZE, 15, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        ...
        pnl_codesProduct1Layout.setHorizontalGroup(
            ...
            .addGroup(pnl_codesProduct1Layout.createSequentialGroup()
                .addComponent(jlbl_barCode1, javax.swing.GroupLayout.PREFERRED_SIZE, 84, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(cbx_iva, javax.swing.GroupLayout.PREFERRED_SIZE, 204, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        pnl_principalProductLayout.setVerticalGroup(
            ...
            .addGroup(pnl_principalProductLayout.createSequentialGroup()
                ...
                .addGap(6, 6, 6)
                .addComponent(pnl_stateProduct, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        ((PlainDocument) txf_equivalent.getDocument()).setDocumentFilter(new MyIntFilter());
        ...
        ((PlainDocument) txf_descOffer.getDocument()).setDocumentFilter(new MyAlphaNumericFilter());
        ...
        ((PlainDocument) txf_quantityOffer.getDocument()).setDocumentFilter(new MyIntFilter());

        lbl_quantityOffer.setText("Cantidad : ");

        lbl_discount2.setText("Descuento : ");

        ((PlainDocument) txf_discount.getDocument()).setDocumentFilter(new MyDoubleFilter());
        ...
        pnl_offerLayout.setVerticalGroup(
            ...
            .addGroup(pnl_offerLayout.createSequentialGroup()
                ...
                .addGroup(pnl_offerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(scp_tblStoreOffer, javax.swing.GroupLayout.DEFAULT_SIZE, 487, Short.MAX_VALUE)
        ...
        ((PlainDocument) txf_descRestoration.getDocument()).setDocumentFilter(new MyAlphaNumericFilter());
        ...
        ((PlainDocument) txf_lowPoint.getDocument()).setDocumentFilter(new MyIntFilter());

        lbl_lowPoint.setText("Punto Min : ");

        lbl_midPoint.setText("Punto Rep  :");

        ((PlainDocument) txf_midPoint.getDocument()).setDocumentFilter(new MyIntFilter());

        ((PlainDocument) txf_peak.getDocument()).setDocumentFilter(new MyIntFilter());
        ...
        ((PlainDocument) txf_descStock.getDocument()).setDocumentFilter(new MyAlphaNumericFilter());
        ...
        ((PlainDocument) txf_quantityStock.getDocument()).setDocumentFilter(new MyIntFilter());
        ...
        pnl_storeStockLayout.setHorizontalGroup(
            ...
            .addGroup(pnl_storeStockLayout.createSequentialGroup()
                ...
                .addGroup(pnl_storeStockLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnl_storeStockLayout.createSequentialGroup()
                        .addGroup(pnl_storeStockLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(lbl_measureStock, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(lbl_storeStock, javax.swing.GroupLayout.DEFAULT_SIZE, 82, Short.MAX_VALUE))
                        .addGap(11, 11, 11)
                        .addGroup(pnl_storeStockLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(pnl_storeStockLayout.createSequentialGroup()
                    ...
                    .addGroup(pnl_storeStockLayout.createSequentialGroup()
                        .addGroup(pnl_storeStockLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(lbl_quantityStock, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(lbl_descStock, javax.swing.GroupLayout.DEFAULT_SIZE, 82, Short.MAX_VALUE))
                        .addGroup(pnl_storeStockLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(pnl_storeStockLayout.createSequentialGroup()
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
        ...
        pnl_stockLayout.setHorizontalGroup(
            ...
            .addGroup(pnl_stockLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(scp_tblStoreStock, javax.swing.GroupLayout.DEFAULT_SIZE, 383, Short.MAX_VALUE)
                .addGap(219, 219, 219))
        );
